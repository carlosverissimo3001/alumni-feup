...
export const queryCode = `query FullQuery{root{isInviteFlowEnabled}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"isInviteFlowEnabled":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"isInviteFlowEnabled":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/4731/main/draft/logic?selected_field_path=root%3EisInviteFlowEnabled"}};
...
const rootFallback = {isInviteFlowEnabled:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/4731/main/draft/logic?selected_field_path=root%3EisInviteFlowEnabled})
   */
  isInviteFlowEnabled({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("isInviteFlowEnabled", { fieldArguments: args });
...
const sourceFallback = {root:{isInviteFlowEnabled:false}};
