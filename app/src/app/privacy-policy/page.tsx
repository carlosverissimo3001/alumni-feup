...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 bg-gradient-to-b from-white to-gray-50">
      <h1 className="text-4xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 py-2">
        Privacy Policy
      </h1>
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-gray-700">
            We use LinkedIn for authentication. Please refer to LinkedIn&apos;s
