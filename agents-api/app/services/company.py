...
from app.utils.company_db import get_all_companies, get_company_by_id, update_company
...
class CompanyService:
    ...
    async def request_company_update(self, params: CompanyUpdateParams):
        ...
        if company_ids:
            ...
            companies = [get_company_by_id(company_id, db) for company_id in company_ids]
        else:
